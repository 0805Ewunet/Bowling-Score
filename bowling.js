// In order to use the bolwing score
// Insert input in the text field a valid string of bowls.
...
function bowlScore(game) {
  ...
  // This is required so they can be counted out once the game is calculating the score.
  var bonusBalls;
